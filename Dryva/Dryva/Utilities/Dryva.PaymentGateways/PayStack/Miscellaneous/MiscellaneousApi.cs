namespace Dryva.PaymentGateways.PayStack
{
    public class MiscellaneousApi : IMiscellaneousApi
    {
        ...
        public ListBanksResponse ListBanks(int itemsPerPage = 50, int page = 1) => _api.Get<ListBanksResponse, dynamic>("bank", new {
            perPage = itemsPerPage,
            page = page
        });

        //?account_number={accountNumber}&bank_code={bankCode}
        public ResolveAccountNumberResponse ResolveAccountNumber(string accountNumber, string bankCode) => _api.Get<ResolveAccountNumberResponse, dynamic>($"bank/resolve", new
        {
