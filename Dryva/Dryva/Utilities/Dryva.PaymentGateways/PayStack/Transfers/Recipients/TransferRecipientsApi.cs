namespace Dryva.PaymentGateways.PayStack
{
    public class TransferRecipientsApi : ITransferRecipientsApi
    {
        ...
        public CreateTransferRecipientResponse Create(CreateTransferRecipientRequest request) => _api.Post<CreateTransferRecipientResponse, CreateTransferRecipientRequest>("transferrecipient", request);
        ...
        public ListTransferRecipientsResponse List(int itemPerPage = 50, int page = 1) => _api.Get<ListTransferRecipientsResponse, dynamic>("transferrecipient", new
        {
            perPage = itemPerPage,
            page = page
        });
