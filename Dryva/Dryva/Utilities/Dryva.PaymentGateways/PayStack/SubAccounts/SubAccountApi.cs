namespace Dryva.PaymentGateways.PayStack
{
    public class SubAccountApi : ISubAccountApi
    {
        ...
        public SubAccountCreateResponse Create(string businessName, string settlementBank, string accountNumber,
            string percentageCharge) =>
            Create(new SubAccountCreateRequest
            {
        ...
        public SubAccountListResponse List(int perPage = 50, int page = 1) =>
            _api.Get<SubAccountListResponse, SubAccountListRequest>("subaccount",
        ...
        public SubAccountUpdateResponse Update(string idOrSlug, SubAccountUpdateRequest request) =>
            _api.Put<SubAccountUpdateResponse, SubAccountUpdateRequest>($"subaccount/{idOrSlug}", request);

        public PayStackBankResponse GetBanks(int perPage = 50, int page = 1) =>
            _api.Get<PayStackBankResponse, PayStackBankRequest>("bank",
