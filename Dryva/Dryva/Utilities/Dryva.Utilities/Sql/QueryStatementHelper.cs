...
namespace Dryva.Utitlties.Sql
{
    ...
    public static class QueryStatementHelper
    {
        ...
        /// </summary>
        /// <typeparam name="TEntity">The type of the DbContext entity.</typeparam>
        /// <typeparam name="TModel">The type of the model.
        /// The model must have the same property names as the entity.</typeparam>
        /// <param name="context">The database context.</param>
        /// <param name="expression">The expression.</param>
        /// <returns>ColumnsBuilder&lt;TModel&gt;.</returns>
        public static ColumnsBuilder<TModel> Select<TEntity, TModel>(this DbContext context,
        ...
        public static DeleteBuilder<TModel> Delete<TEntity, TModel>(this DbContext context)
            where TEntity : class
            where TModel : class
        {
            var entityType = context.Model.FindEntityType(typeof(TEntity));
